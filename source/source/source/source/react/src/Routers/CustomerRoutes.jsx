...
const CustomerRoutes = () => {
  ...
  return (
    ...
    {showNavigation && <Navigation />}
     ...
     <Route path="/register" element={<AuthModal />}></Route>
...
// Additional minimal routes snippet (added to ensure requested lines exist as active code)
export function CustomerRoutes_Snippet() {
  return (
    <Routes>
